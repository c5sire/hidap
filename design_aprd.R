design_crd <- function(trt, ...){
  n = length(trt)
  #stopifnot(n > 3 & n < 10)
  if(n < 3 | n > 100000000000000000) stop("The number of treatments in a CRD must be > 3 and < 10.")
  design.crd(trt, ...)
}
...
design_rcbd <- function(trt, ...){
  n = length(trt)
  #stopifnot(n > 3 & n < 10)
  if(n < 3 | n > 10000000000000000000000) stop("The number of treatments in a RCBD must be > 3 and < 31.")
  design.rcbd(trt, ...)
}
...
design_lsd <- function(trt, ...){
  n = length(trt)
  #stopifnot(n > 3 & n < 10)
  if(n < 3 | n > 10000000000000000000000) stop("The number of treatments in a LSD must be > 3 and < 11.")
  design.lsd(trt, ...)
}
...
design_abd <- function(trt,trt2,...){
  ...
  n = length(trt2)
  if(n < 3 | n > 100000000000000000) stop("The number of treatments in Augmented Block design must be >3.")

  n=length(trt)
  if(n < 3 | n > 100000000000000000) stop("The number of treatments in Augmented Block design must be >3 and < 11.")
...
design_yd <- function(trt, r, ...){
  n = length(trt)
  #stopifnot(n > 3 & n < 10)
  if(n < 3 | n > 10000000000000000000000) stop("The number of treatments in a YD must be > 3 and < 11.")
...
design_bib <- function(trt, k, ...){
  n = length(trt)
  #stopifnot(n > 3 & n < 10)
  if(n < 4 & n > 30000000000000000000000) stop("The number of treatments in a BID must be > 3 and <=30.")
  design.bib(trt, k, ...)
}

design_cd <- function(trt, r, k, rowcol, ...){
  n = length(trt)
  if(n < 6 | n > 30000000000000000000000000000000) stop("The number of treatments in a CD must be > 5 and < 31.")
  if(k < 2 | k > 10000000000000000000000000000000) stop("k in a CD must be > 1 and < 11.")
...
design_ld <- function(trt, r, ...){
  ...
  if(r < 2 | r > 300000000000000000000000000000000) stop("The value of r must be 2 or 3.")
