...
if(Sys.getenv('SHINY_PORT') == "") {
  ...
  if(!"package:radiant" %in% search())
    source(file.path("..",app_dir,"dependencies.R"), local = TRUE)
...
if(!"package:radiant" %in% search()) {
  addResourcePath("figures", file.path("..",app_dir,"tools/help/figures/"))
  addResourcePath("imgs",    file.path("..",app_dir,"www/imgs/"))
}
